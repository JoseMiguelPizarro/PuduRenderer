...
void NewPuduAppTemplate::OnInit()
{
    ...
    skyboxLoadSettings.format = ChannelFormat::R32G32B32A32_SFLOAT;
...
void NewPuduAppTemplate::DrawImGUI()
{
    PuduApp::DrawImGUI();
}
