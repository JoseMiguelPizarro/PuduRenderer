...
namespace Pudu
{
    ...
    void PuduGraphics::UpdateBindlessTexture(GPUResourceHandle handle)
    {
    ...
    void PuduGraphics::CreateDescriptorsLayouts(std::vector<DescriptorSetLayoutData>& layoutData,
                                                std::vector<DescriptorSetLayoutHandle>& out)
    {
    ...
    GPUResourceHandle PuduGraphics::CreateTexture(TextureCreationData const& creationData)
    {
    ...
    void PuduGraphics::CreateVKTexture(Texture* texture)
    {
        ...
        uint32_t dataSize = texture->dataSize;
