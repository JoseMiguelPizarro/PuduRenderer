...
namespace Pudu
{
    ...
    struct RenderPassAttachments
    {
        ...
        RenderPassAttachments& AddBufferAttachment(SPtr<GraphicsBuffer> buffer,
                                                   AttachmentAccessUsage usage = AttachmentAccessUsage::Write);
    ...
    public:
        ...
        RenderPass* AddColorAttachment(SPtr<RenderTexture> rt,
                                       AttachmentAccessUsage accessUsage = AttachmentAccessUsage::Write,
                                       LoadOperation loadOp = LoadOperation::DontCare, vec4 clearColor = vec4(0));
        RenderPass* AddDepthStencilAttachment(SPtr<RenderTexture> rt,
                                              AttachmentAccessUsage accessUsage = AttachmentAccessUsage::Write,
                                              LoadOperation loadOp = LoadOperation::DontCare, float depthClear = 1.0f,
        ...
        RenderPass* SetColorBlending(VkBlendFactor sourceColor, VkBlendFactor destinationColor,
                                     VkBlendOp colorOperation);
        RenderPass* SetAlphaBlending(VkBlendFactor sourceAlpha, VkBlendFactor destinationAlpha,
        ...
        GPUResourceType Type() override { return GPUResourceType::RenderPass; };
